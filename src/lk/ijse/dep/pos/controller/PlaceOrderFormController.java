...
public class PlaceOrderFormController {
    ...
    public void initialize() {
        ...
        try {
            ...
            new Alert(Alert.AlertType.ERROR,"Something went wrong, please contact DEPPO123").show();
        ...
        cmbCustomerId.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                try {
                    ...
                    new Alert(Alert.AlertType.ERROR,"Something went wrong, please contact DEPPO222").show();
                    Logger.getLogger("lk.ijse.dep.pos.controller").log(Level.SEVERE, null,e);
                }
            }
        });
        ...
        cmbItemCode.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                try {
                    ...
                    new Alert(Alert.AlertType.ERROR,"Something went wrong, please contact DEPPO4444").show();
                    Logger.getLogger("lk.ijse.dep.pos.controller").log(Level.SEVERE, null,e);
                }
            }
        });
                ...
                for (ItemDTO tempItem : tempItems) {
                    if (tempItem.getCode().equals(selectedOrderDetail.getCode())) {
                        try {
                            ...
                            new Alert(Alert.AlertType.ERROR,"Something went wrong, please contact DEPPO5555").show();
                            Logger.getLogger("lk.ijse.dep.pos.controller").log(Level.SEVERE, null,e);
                        }
                    }
                }
    ...
    public void btnPlaceOrder_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            JasperReport jasperReport = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("/lk/ijse/dep/pos/report/order-report2.jasper"));
            ...
            session.doWork(connection -> {
                ...
                try {
                    ...
                    new Alert(Alert.AlertType.ERROR,"Jasper Report Loading Failed ").show();
                    Logger.getLogger("lk.ijse.dep.pos.controller").log(Level.SEVERE, null,e);
                }
                JasperViewer.viewReport(jasperPrint, false);
            });
        } catch (Exception e) {
            new Alert(Alert.AlertType.ERROR,"Something went wrong, please contact DEPPO777").show();
            Logger.getLogger("lk.ijse.dep.pos.controller").log(Level.SEVERE, null,e);
        }
        reset();
    }
